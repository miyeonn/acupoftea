...
public class SendOrderMail {
	...
	public void mailSend(String today) {
		...
		String title = today+"판매현황"; // 
		String content = getContent(); // 내용
	...
	public String getContent() {
		...
		String content="";
		 content+="<p></p><p>(날짜) 판매수량 입니다.</p>";
		 content+="<table class='__se_tbl' border='0' cellpadding='0' cellspacing='1' style='background-color: rgb(199, 199, 199);'><tbody><tr>";
		 content+="<td style='padding: 3px 4px 2px; color: rgb(102, 102, 102); width: 151px; height: 19px; background-color: rgb(255, 255, 255);'>";
		 ...
		 content+="<p>주문수량&nbsp;</p></td><td style='padding: 3px 4px 2px; color: rgb(102, 102, 102); width: 152px; height: 19px; background-color: rgb(255, 255, 255);'>";
		 content+="<p>금액&nbsp;</p></td></tr></tbody>";
		 content+="</table><p></p><p><a href='http://localhost:8080/user/login' target='_blank' style='cursor: pointer; white-space: pre;' rel='noreferrer noopener'>주문내역 관리로 이동</a><span></span></p>";
